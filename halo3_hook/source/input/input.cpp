...
{
	input_update__original = main_get_typed_module_address<decltype(input_update__original)>(0xC535C);
...
{
	return main_get_typed_module_address<decltype(&input_key_frames_down)>(0xC581C)(key_code);
}
