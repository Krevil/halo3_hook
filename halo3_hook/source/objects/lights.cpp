...
{
	c_function_definition__evaluate_color = main_get_module_pointer_at_offset<decltype(c_function_definition__evaluate_color)>(0x43C1C0);
	c_function_definition__evaluate_scalar = main_get_module_pointer_at_offset<decltype(c_function_definition__evaluate_scalar)>(0x43C660);
	light_update_state = main_get_module_pointer_at_offset<decltype(light_update_state)>(0x5C1040);
