...
{
	global_structure_design_get__original = main_get_from_module_offset<decltype(global_structure_design_get__original)>(0x244F40);
	scenario_position_inside_safe_zone__original = main_get_from_module_offset<decltype(scenario_position_inside_safe_zone__original)>(0x246150);
