...
{
	scenario_kill_trigger_volume_test_object__original = main_get_module_pointer_at_offset<decltype(scenario_kill_trigger_volume_test_object__original)>(0x383110);
