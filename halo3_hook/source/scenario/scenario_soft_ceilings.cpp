...
{
    scenario_soft_ceilings_get_features__original = main_get_from_module_offset<decltype(scenario_soft_ceilings_get_features__original)>(0x389E80);
    scenario_soft_ceilings_object_is_on_kill_surface__original = main_get_from_module_offset<decltype(scenario_soft_ceilings_object_is_on_kill_surface__original)>(0x38A410);
    scenario_soft_ceilings_pin_camera_position__original = main_get_from_module_offset<decltype(scenario_soft_ceilings_pin_camera_position__original)>(0x38A700);
    scenario_soft_ceilings_update_object__original = main_get_from_module_offset<decltype(scenario_soft_ceilings_update_object__original)>(0x38AC60);
