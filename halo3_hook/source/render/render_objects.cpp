...
{
	render_objects_prepare_for_window__original = main_get_module_offset<decltype(render_objects_prepare_for_window__original)>(0x472000);
...
void __fastcall render_objects_prepare_for_window(long user_index)
{
	...
	{
		bool *g_motion_blur_enabled = main_get_module_offset<bool *>(0x8FD910);
