...
{
	screen_effect_sample__original = main_get_module_pointer_at_offset<decltype(screen_effect_sample__original)>(0x377C40);
	...
	long first_person_user_index)
{
	...
	s_data_array *screen_effects = *main_get_tls_pointer_at_offset<s_data_array **>(0x210);
